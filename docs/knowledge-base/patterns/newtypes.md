...
All `<Entity>Id`s live in `lib/common/.../domain/model/NewTypes.scala` — centralized. Quill `MappedEncoding`s for them live with the rest of the persistence infrastructure in `lib/db/.../impl/sql/NewTypeEncodings.scala`.

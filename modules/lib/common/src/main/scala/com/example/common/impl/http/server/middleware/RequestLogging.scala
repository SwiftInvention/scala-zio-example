package com.example.common.impl.http.server.middleware
...
/** HTTP middleware that puts request context onto every log line.
  *
  * Two pieces:
  *
  ...
  *
  * Apply at the composition root (`ServerRoutes`) so every route gets the middleware regardless of which context owns
  * it.
  *
